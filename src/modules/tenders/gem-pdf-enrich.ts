...
export function applyPdfDetailsToTender(
  ...
  return {
    ...
    startDate: applyPdfField(tender.startDate || tender.gemStartDate, details.startDate),
    gemStartDate: applyPdfField(tender.gemStartDate, details.startDate),
    endDate: applyPdfField(tender.endDate || tender.gemEndDate, details.endDate),
    gemEndDate: applyPdfField(tender.gemEndDate, details.endDate),
